...
String deviceId = "Mazkaa_1";
String pubTopic = String(deviceId + "/sensor_data_mazkaa");
String subTopic = String(deviceId + "/led_status_mazkaa");
...
void connectToMqtt() {
    while (!ESPMqtt.connected()) {
        ...
        if (ESPMqtt.connect("ESP32Client-mazkaa", mqttUser.c_str(), mqttPwd.c_str())) {
