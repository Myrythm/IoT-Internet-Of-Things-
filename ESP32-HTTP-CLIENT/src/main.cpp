...
const char *ssid = "Onesfam";
const char *password = "teunyaho";
...
void telePrintChatId() {
  http.begin("https://api.telegram.org/bot6756040579:AAHFEY8OmzrxkH9FJtBqw7ITHkX_j42IZWo/getUpdates");
